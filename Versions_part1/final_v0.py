...
#  bib haar versie van epsilon decay
...
NUMBER_OF_STEPS = 6000 * 11
NUMBER_OF_TESTING_EPOCHS = 10
NUMBER_OF_OBSERVATION_STEPS = 128 * 11 
...
def get_exploration_rate(step, old_exploration_rate): 
    ...
    if step < NUMBER_OF_OBSERVATION_STEPS:
        ...
        exploration_rate = np.interp(step, [0, EPSILON_DECAY], [EPSILON_START, EPSILON_END])
        if step%1000 == 0:
            print("For step ", step, ", we have an exploration rate of ", exploration_rate)
